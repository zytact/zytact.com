...
const FileDownLogo = () => {
    return (
        ...
        >
            <FileDown className="size-10 text-[rgba(var(--accent-blue),0.7)] transition-all duration-300 hover:scale-90 hover:text-[rgb(var(--accent-blue))]" />
        </Link>
    );
};
    ...
    return (
        ...
        >
            <svg
                ...
                y="0px"
                viewBox="0 0 50 50"
                className="size-10 fill-current text-[rgba(var(--accent-blue),0.7)] transition-all duration-300 hover:scale-90 hover:text-[rgb(var(--accent-blue))]"
            >
